...
*   Добавлено [свойство UserAgent,][ReferenceWin32Icorewebview2experimentalsettings10781PreReleaseGetUserAgent] чтобы получить или установить агент пользователя.  \([\#122][GithubMicrosoftedgeWebviewfeedbackIssue122]\).
