...
<span data-ttu-id="42d03-111">Чтобы остановить запись запросов, выполните следующие действия.</span><span class="sxs-lookup"><span data-stu-id="42d03-111">To stop recording requests, complete the following steps.</span></span>  
...
<span data-ttu-id="42d03-125">Снимите скриншоты для анализа отображаемой информации для пользователей в ожидании загрузки страницы.</span><span class="sxs-lookup"><span data-stu-id="42d03-125">Capture screenshots to analyze what displays for users while waiting for your page to load.</span></span>  
...
<span data-ttu-id="42d03-179">Если текстовое поле не отображается, возможно, будет скрыта области **Фильтры.**</span><span class="sxs-lookup"><span data-stu-id="42d03-179">If the text box is not displayed, the **Filters** pane is probably hidden.</span></span>  
...
| `mixed-content` | <span data-ttu-id="42d03-203">Показать все смешанные ресурсы контента \( \) или только те, которые в настоящее время `mixed-content:all` отображаются `mixed-content:displayed` \( \).</span><span class="sxs-lookup"><span data-stu-id="42d03-203">Show all mixed content resources \(`mixed-content:all`\) or just the ones that are currently displayed \(`mixed-content:displayed`\).</span></span> |  
...
<span data-ttu-id="42d03-229">Чтобы включить несколько фильтров типа одновременно, удерживайте `Control` \(Windows, Linux\) `Command` или \(macOS\) и выберите.</span><span class="sxs-lookup"><span data-stu-id="42d03-229">To enable multiple type filters simultaneously, hold `Control` \(Windows, Linux\) or `Command` \(macOS\) and then choose.</span></span>  
...
## <a name="sort-requests"></a><span data-ttu-id="42d03-244">Сортировка запросов</span><span class="sxs-lookup"><span data-stu-id="42d03-244">Sort requests</span></span>  
...
:::row:::
   :::column span="1":::
      **<span data-ttu-id="42d03-256">Общая продолжительность</span><span class="sxs-lookup"><span data-stu-id="42d03-256">Total Duration</span></span>**  
   :::column-end:::
   :::column span="2":::
...
<span data-ttu-id="42d03-268">Используйте таблицу Запросы, чтобы отобразить журнал всех запросов, сделанных во время открытия DevTools.</span><span class="sxs-lookup"><span data-stu-id="42d03-268">Use the Requests table to display a log of all requests made while DevTools have been open.</span></span>  <span data-ttu-id="42d03-269">Чтобы получить дополнительные сведения о каждом элементе, выберите или наведите курсор на запросы.</span><span class="sxs-lookup"><span data-stu-id="42d03-269">To reveals more information about each item, choose or hover on requests.</span></span>  
...
:::row:::
   ...
   :::column span="2":::
      ...
      *   <span data-ttu-id="42d03-281">**Parser**  Parser HTML для Microsoft Edge.</span><span class="sxs-lookup"><span data-stu-id="42d03-281">**Parser**  The HTML parser for Microsoft Edge.</span></span>  
...
### <a name="display-http-headers"></a><span data-ttu-id="42d03-320">Отображение http-заглавок</span><span class="sxs-lookup"><span data-stu-id="42d03-320">Display HTTP headers</span></span>  
...
### <a name="display-cookies"></a><span data-ttu-id="42d03-349">Отображение файлов cookie</span><span class="sxs-lookup"><span data-stu-id="42d03-349">Display cookies</span></span>  
...
<span data-ttu-id="42d03-363">Дополнительные сведения о каждом из этапов.</span><span class="sxs-lookup"><span data-stu-id="42d03-363">More information about each of the phases.</span></span>  
...
### <a name="display-initiators-and-dependencies"></a><span data-ttu-id="42d03-402">Отображение инициаторов и зависимостей</span><span class="sxs-lookup"><span data-stu-id="42d03-402">Display initiators and dependencies</span></span>  
...
### <a name="display-the-total-number-of-requests"></a><span data-ttu-id="42d03-416">Отображение общего числа запросов</span><span class="sxs-lookup"><span data-stu-id="42d03-416">Display the total number of requests</span></span>  
...
### <a name="display-the-stack-trace-that-caused-a-request"></a><span data-ttu-id="42d03-429">Отображение трассировки стека, вызываемой запросом</span><span class="sxs-lookup"><span data-stu-id="42d03-429">Display the stack trace that caused a request</span></span>  
...
<span data-ttu-id="42d03-439">Чтобы сохранить все сетевые запросы в файл HAR, выполните следующие действия.</span><span class="sxs-lookup"><span data-stu-id="42d03-439">To save all network requests to a HAR file, complete the following steps.</span></span>  
...
### <a name="copy-one-or-more-requests-to-the-clipboard"></a><span data-ttu-id="42d03-449">Скопируйте один или несколько запросов в буфер обмена</span><span class="sxs-lookup"><span data-stu-id="42d03-449">Copy one or more requests to the clipboard</span></span>  

<span data-ttu-id="42d03-450">В **столбце Имя** таблицы Запросы наведите курсор на запрос, откройте контекстное меню \(правой кнопкой мыши\), наведите курсор на **копию**и выберите один из следующих параметров.</span><span class="sxs-lookup"><span data-stu-id="42d03-450">Under the **Name** column of the Requests table, hover on a request, open the contextual menu \(right-click\), hover on **Copy**, and choose one of the following options.</span></span>  

| <span data-ttu-id="42d03-451">Название</span><span class="sxs-lookup"><span data-stu-id="42d03-451">Name</span></span> | <span data-ttu-id="42d03-452">Подробные сведения</span><span class="sxs-lookup"><span data-stu-id="42d03-452">Details</span></span> |  
|:--- |:--- |  
| **<span data-ttu-id="42d03-453">Адрес ссылки копирования</span><span class="sxs-lookup"><span data-stu-id="42d03-453">Copy Link Address</span></span>** | <span data-ttu-id="42d03-454">Скопируйте URL-адрес запроса в буфер обмена.</span><span class="sxs-lookup"><span data-stu-id="42d03-454">Copy the URL of the request to the clipboard.</span></span> |  
| **<span data-ttu-id="42d03-455">Копирование ответа</span><span class="sxs-lookup"><span data-stu-id="42d03-455">Copy Response</span></span>** | <span data-ttu-id="42d03-456">Скопируйте текст ответа на буфер обмена.</span><span class="sxs-lookup"><span data-stu-id="42d03-456">Copy the response body to the clipboard.</span></span> |  
| **<span data-ttu-id="42d03-457">Скопируйте как fetch</span><span class="sxs-lookup"><span data-stu-id="42d03-457">Copy as Fetch</span></span>** | &nbsp; |  
| **<span data-ttu-id="42d03-458">Скопируйте как cURL</span><span class="sxs-lookup"><span data-stu-id="42d03-458">Copy as cURL</span></span>** | <span data-ttu-id="42d03-459">Скопируйте запрос в качестве команды cURL.</span><span class="sxs-lookup"><span data-stu-id="42d03-459">Copy the request as a cURL command.</span></span> |  
| **<span data-ttu-id="42d03-460">Скопируйте все как fetch</span><span class="sxs-lookup"><span data-stu-id="42d03-460">Copy All as Fetch</span></span>** | &nbsp; |  
| **<span data-ttu-id="42d03-461">Скопируйте все как cURL</span><span class="sxs-lookup"><span data-stu-id="42d03-461">Copy All as cURL</span></span>** | <span data-ttu-id="42d03-462">Скопируйте все запросы в виде цепочки команд cURL.</span><span class="sxs-lookup"><span data-stu-id="42d03-462">Copy all requests as a chain of cURL commands.</span></span> |  
| **<span data-ttu-id="42d03-463">Скопируйте все как HAR</span><span class="sxs-lookup"><span data-stu-id="42d03-463">Copy All as HAR</span></span>** | <span data-ttu-id="42d03-464">Скопируйте все запросы в виде данных HAR.</span><span class="sxs-lookup"><span data-stu-id="42d03-464">Copy all requests as HAR data.</span></span> |  
...
:::image type="complex" source="../media/network-network-requests-copy-response.msft.png" alt-text="Выбор ответа на копирование" lightbox="../media/network-network-requests-copy-response.msft.png":::
   <span data-ttu-id="42d03-466">Выбор **ответа на копирование**</span><span class="sxs-lookup"><span data-stu-id="42d03-466">Choose **Copy Response**</span></span>  
:::image-end:::  

### <a name="copy-formatted-response-json-to-the-clipboard"></a><span data-ttu-id="42d03-467">Скопируйте форматированный ответ JSON на буфер обмена</span><span class="sxs-lookup"><span data-stu-id="42d03-467">Copy formatted response JSON to the clipboard</span></span>  

<span data-ttu-id="42d03-468">Выберите сетевой запрос и перейдите на области **headers.**</span><span class="sxs-lookup"><span data-stu-id="42d03-468">Choose a network request and navigate to the **Headers** pane.</span></span>  <span data-ttu-id="42d03-469">Чтобы скопировать значение JSON ответа, \*\*\*\* перейдите на запрос полезной нагрузки, наведите курсор на содержимое отклика JSON, откройте контекстное меню \(правой кнопкой мыши\) и выберите значение **Copy Value**.</span><span class="sxs-lookup"><span data-stu-id="42d03-469">To copy the JSON value of a response, navigate to **Request payload**, hover on the JSON response content, open the contextual menu \(right-click\), and choose **Copy Value**.</span></span>  
...
:::row:::
   :::column span="":::
        :::image type="complex" source="../media/network-header-copy-property-value.msft.png" alt-text="Скопируйте значение в контекстной меню" lightbox="../media/network-header-copy-property-value.msft.png":::
          <span data-ttu-id="42d03-471">**Скопируйте значение** в контекстной меню</span><span class="sxs-lookup"><span data-stu-id="42d03-471">**Copy Value** in contextual menu</span></span>  
        :::image-end:::  
   :::column-end:::
   :::column span="":::
        :::image type="complex" source="../media/network-header-paste-property-value.msft.png" alt-text="Код Visual Studio Microsoft с форматированный ответ JSON" lightbox="../media/network-header-paste-property-value.msft.png":::
          <span data-ttu-id="42d03-473">Вклеить форматированный ответ JSON в Microsoft Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="42d03-473">Pasting formatted response JSON in Microsoft Visual Studio Code</span></span>  
        :::image-end:::  
   :::column-end:::
:::row-end:::  

### <a name="copy-property-values-from-network-requests-to-your-clipboard"></a><span data-ttu-id="42d03-474">Копирование значений свойств из сетевых запросов в буфер обмена</span><span class="sxs-lookup"><span data-stu-id="42d03-474">Copy property values from network requests to your clipboard</span></span>  

<span data-ttu-id="42d03-475">Чтобы скопировать значения свойств из сетевых запросов в буфер обмена, выполните следующие действия.</span><span class="sxs-lookup"><span data-stu-id="42d03-475">To copy property values from network requests to your clipboard, complete the following actions.</span></span>  

1.  <span data-ttu-id="42d03-476">Откройте области **заготки.**</span><span class="sxs-lookup"><span data-stu-id="42d03-476">Open the **Headers** pane.</span></span>  
1.  <span data-ttu-id="42d03-477">Откройте один из следующих разделов загона.</span><span class="sxs-lookup"><span data-stu-id="42d03-477">Open one of the following header sections.</span></span>  
    *   <span data-ttu-id="42d03-478">Запрос полезной нагрузки \(JSON\)</span><span class="sxs-lookup"><span data-stu-id="42d03-478">Request payload \(JSON\)</span></span>  
    *   <span data-ttu-id="42d03-479">Данные форм</span><span class="sxs-lookup"><span data-stu-id="42d03-479">Form Data</span></span>  
    *   <span data-ttu-id="42d03-480">Параметры строки запроса</span><span class="sxs-lookup"><span data-stu-id="42d03-480">Query String Parameters</span></span>  
    *   <span data-ttu-id="42d03-481">Запрашивать заглавные</span><span class="sxs-lookup"><span data-stu-id="42d03-481">Request Headers</span></span>  
    *   <span data-ttu-id="42d03-482">Заготчики ответа</span><span class="sxs-lookup"><span data-stu-id="42d03-482">Response Headers</span></span>  
1.  <span data-ttu-id="42d03-483">Откройте контекстное меню \(правой кнопкой мыши\) > **значение Copy**.</span><span class="sxs-lookup"><span data-stu-id="42d03-483">Open the contextual menu \(right-click\) > **Copy value**.</span></span>  <span data-ttu-id="42d03-484">Теперь вы можете вклеить значение в любой редактор, чтобы просмотреть его.</span><span class="sxs-lookup"><span data-stu-id="42d03-484">You may now paste the value into any editor to review it.</span></span>  
    
## <a name="change-the-layout-of-the-network-panel"></a><span data-ttu-id="42d03-485">Изменение макета панели Network</span><span class="sxs-lookup"><span data-stu-id="42d03-485">Change the layout of the Network panel</span></span>  

<span data-ttu-id="42d03-486">Вы можете расширить или обвалить **разделы** пользовательского интерфейса сетевых инструментов, чтобы сосредоточиться на важных сведениях.</span><span class="sxs-lookup"><span data-stu-id="42d03-486">You may expand or collapse sections of the **Network** tool UI to focus important information.</span></span>  

### <a name="hide-the-filters-pane"></a><span data-ttu-id="42d03-487">Скрыть области фильтров</span><span class="sxs-lookup"><span data-stu-id="42d03-487">Hide the Filters pane</span></span>  

<span data-ttu-id="42d03-488">По умолчанию в DevTools покажут **области фильтров.**</span><span class="sxs-lookup"><span data-stu-id="42d03-488">By default, DevTools show the **Filters** pane.</span></span>  
<span data-ttu-id="42d03-489">Выберите **фильтр** \( ![ Фильтр ][ImageFilterIcon] \) для его сокрытия.</span><span class="sxs-lookup"><span data-stu-id="42d03-489">Choose **Filter** \(![Filter][ImageFilterIcon]\) to hide it.</span></span>  
...
:::image type="complex" source="../media/network-network-resources-hide-filters-button.msft.png" alt-text="Кнопка "Скрыть фильтры"" lightbox="../media/network-network-resources-hide-filters-button.msft.png":::
   <span data-ttu-id="42d03-491">Кнопка "Скрыть фильтры"</span><span class="sxs-lookup"><span data-stu-id="42d03-491">The Hide Filters button</span></span>  
:::image-end:::  

### <a name="use-large-request-rows"></a><span data-ttu-id="42d03-492">Использование больших строк запросов</span><span class="sxs-lookup"><span data-stu-id="42d03-492">Use large request rows</span></span>  

<span data-ttu-id="42d03-493">Используйте большие строки, если в таблице сетевых запросов нужно больше белого пространства.</span><span class="sxs-lookup"><span data-stu-id="42d03-493">Use large rows when you want more whitespace in your network requests table.</span></span>  <span data-ttu-id="42d03-494">Некоторые столбцы также предоставляют дополнительные сведения при использовании больших строк.</span><span class="sxs-lookup"><span data-stu-id="42d03-494">Some columns also provide a little more information when using large rows.</span></span>  <span data-ttu-id="42d03-495">Например, нижнее значение столбца **Size** — это ненапечатаный размер запроса.</span><span class="sxs-lookup"><span data-stu-id="42d03-495">For example, the bottom value of the **Size** column is the uncompressed size of a request.</span></span>  
...
:::image type="complex" source="../media/network-network-requests-large-request-rows.msft.png" alt-text="Пример больших строк запросов в области Запросы" lightbox="../media/network-network-requests-large-request-rows.msft.png":::
   <span data-ttu-id="42d03-497">Пример больших строк запросов в области **Запросы**</span><span class="sxs-lookup"><span data-stu-id="42d03-497">An example of large request rows in the **Requests** pane</span></span>  
:::image-end:::  

<span data-ttu-id="42d03-498">Чтобы включить большие строки, включим почтовый ящик **Use large request rows.**</span><span class="sxs-lookup"><span data-stu-id="42d03-498">To enable large rows, turn on the **Use large request rows** checkbox.</span></span>  
...
:::image type="complex" source="../media/network-network-requests-use-large-request-rows-on.msft.png" alt-text="Почтовый ящик Use large request rows" lightbox="../media/network-network-requests-use-large-request-rows-on.msft.png":::
   <span data-ttu-id="42d03-500">Почтовый **ящик Use large request rows**</span><span class="sxs-lookup"><span data-stu-id="42d03-500">The **Use large request rows** checkbox</span></span>  
:::image-end:::  

### <a name="hide-the-overview-pane"></a><span data-ttu-id="42d03-501">Скрыть области Обзор</span><span class="sxs-lookup"><span data-stu-id="42d03-501">Hide the Overview pane</span></span>  

<span data-ttu-id="42d03-502">По умолчанию в DevTools отображается области **Обзор.**</span><span class="sxs-lookup"><span data-stu-id="42d03-502">By default, DevTools displays the **Overview** pane.</span></span>  <span data-ttu-id="42d03-503">Чтобы скрыть это, выключите **контрольный ящик "Обзор** шоу".</span><span class="sxs-lookup"><span data-stu-id="42d03-503">To hide it, turn off the **Show Overview** checkbox.</span></span>  
...
:::image type="complex" source="../media/network-network-requests-show-overview-off.msft.png" alt-text="Контрольный ящик "Обзор шоу"" lightbox="../media/network-network-requests-show-overview-off.msft.png":::
   <span data-ttu-id="42d03-505">Контрольный **ящик "Обзор** шоу"</span><span class="sxs-lookup"><span data-stu-id="42d03-505">The **Show Overview** checkbox</span></span>  
:::image-end:::  

## <a name="getting-in-touch-with-the-microsoft-edge-devtools-team"></a><span data-ttu-id="42d03-506">Взаимодействие с командой средств разработчика Microsoft Edge</span><span class="sxs-lookup"><span data-stu-id="42d03-506">Getting in touch with the Microsoft Edge DevTools team</span></span>  
...
> [!NOTE]
> <span data-ttu-id="42d03-510">Некоторые части этой страницы представляют собой измененные материалы, созданные и [предоставленные корпорацией Google][GoogleSitePolicies]. Их использование регулируется условиями, описанными в [лицензии Creative Commons Attribution 4.0 International License][CCA4IL].</span><span class="sxs-lookup"><span data-stu-id="42d03-510">Portions of this page are modifications based on work created and [shared by Google][GoogleSitePolicies] and used according to terms described in the [Creative Commons Attribution 4.0 International License][CCA4IL].</span></span>  
> <span data-ttu-id="42d03-511">Оригинальная страница [](https://developers.google.com/web/tools/chrome-devtools/network/reference) находится здесь и является автором [Kayce Basques][KayceBasques] \(Технический писатель, Chrome DevTools \& Маяк\).</span><span class="sxs-lookup"><span data-stu-id="42d03-511">The original page is found [here](https://developers.google.com/web/tools/chrome-devtools/network/reference) and is authored by [Kayce Basques][KayceBasques] \(Technical Writer, Chrome DevTools \& Lighthouse\).</span></span>  

[![Лицензия Creative Commons][CCby4Image]][CCA4IL]  
<span data-ttu-id="42d03-513">Эта работа предоставляется в рамках международной лицензии [Creative Commons Attribution 4.0 International License][CCA4IL].</span><span class="sxs-lookup"><span data-stu-id="42d03-513">This work is licensed under a [Creative Commons Attribution 4.0 International License][CCA4IL].</span></span>  
